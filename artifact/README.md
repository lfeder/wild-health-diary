...
It declares three runtime capabilities:
...
- `downloads` — the Export JSON button.

With none of them available the page falls back to this browser's local storage and says so
in the header pill.
