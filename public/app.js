...
function metricsText(d){return [['recovery','Recovery','%'],['strain','Day strain',''],['sleep','Sleep',' h'],['rhr','RHR',' bpm']].filter(([k])=>d.metrics[k]!=null).map(([k,label,unit])=>label+' '+d.metrics[k]+unit).join(' · ');}
